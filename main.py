...
with open("data 1.json","r",encoding="utf-8") as f: # encoding set to utf-8 to handle any special characters in the json files
    jsonData1 = json.load(f)
with open("data 2.json","r",encoding="utf-8") as f: # encoding set to utf-8 to handle any special characters in the json files
    jsonData2 = json.load(f)
with open("data-result.json","r",encoding="utf-8") as f: # encoding set to utf-8 to handle any special characters in the json files
